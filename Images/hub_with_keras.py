...
# Use hub.module to load a mobileNet, and tf.keras.layers.
# Lambda to wrap it up as a keras layer.
# Any TensorFlow 2 compatible image classifier URL from tf_hub.dev will work here.
...
"""This saved model can loaded for inference later, or converted to [TFLite](https://www.tensorflow.org/lite/convert/) 
or [TFjs](https://github.com/tensorflow/tfjs-converter)."""
