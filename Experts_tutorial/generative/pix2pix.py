...
"""This notebook demonstrates image to image translation using conditional GAN's,
   ...
   convert google maps to google earth, etc. Here, we convert building facades
   to real buildings.
"""
...
def norm(input_image, real_image):
...
def random_jitter(input_image, real_image):
  # resize image 286 x 286 x 3
  input_image, real_image = resize(input_image, real_image, 286, 286)

  # random crop 256 x 256 x 3
...
def load_image_train(image_file):
  ...
  input_image, real_image = norm(input_image, real_image)
